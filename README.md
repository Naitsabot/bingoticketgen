...
This was initially written for a bingo-event for bachelor students, so the current version of the tickets have special formatting on the number "69" because, because.
